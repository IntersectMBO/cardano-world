...
in
  with data-merge; {
    vasil-qa = {
      bft-0 = merge (cardano.nomadJob.default constants.envs.vasil-qa) {
        ...
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "cardano/vasil-qa/bft-0";
      ...
      bft-1 = merge cardano.nomadJob.default constants.envs.vasil-qa {
        # job.cardano.group.cardano.task.node.env.ENVIRONMENT = "testnet";
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "cardano/vasil-qa/bft-1";
        job.cardano.group.cardano.task.node.env.LOCAL_ROOTS_SRV_DNS = "_vasil-qa-bft-1-node._tcp.service.consul";
        job.cardano.group.cardano.task.node.env.PUBLIC_ROOTS_SRV_DNS = "_vasil-qa-node._tcp.service.consul";
      };
      bft-2 = merge cardano.nomadJob.default constants.envs.vasil-qa {
        # job.cardano.group.cardano.task.node.env.ENVIRONMENT = "testnet";
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "cardano/vasil-qa/bft-2";
        job.cardano.group.cardano.task.node.env.LOCAL_ROOTS_SRV_DNS = "_vasil-qa-bft-2-node._tcp.service.consul";
        job.cardano.group.cardano.task.node.env.PUBLIC_ROOTS_SRV_DNS = "_vasil-qa-node._tcp.service.consul";
      };
      sp-1 = merge cardano.nomadJob.default constants.envs.vasil-qa {
        # job.cardano.group.cardano.task.node.env.ENVIRONMENT = "testnet";
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "cardano/vasil-qa/sp-1";
