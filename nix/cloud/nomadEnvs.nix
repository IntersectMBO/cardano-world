  ...
  with data-merge; {
    vasil-qa = {
      bft-0 = merge (cardano.nomadJob.default constants.envs.vasil-qa // {datacenters = ["eu-central-1"];}) {
        ...
        # job.cardano.group.cardano.task.node.env.DEBUG_SLEEP = 6000;
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "config/cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "kv/data/cardano/vasil-qa/bft-0";
      ...
      bft-1 = merge (cardano.nomadJob.default constants.envs.vasil-qa // {datacenters = ["eu-west-1"];}) {
        # job.cardano.group.cardano.task.node.env.ENVIRONMENT = "testnet";
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "config/cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "kv/data/cardano/vasil-qa/bft-1";
      ...
      bft-2 = merge (cardano.nomadJob.default constants.envs.vasil-qa // {datacenters = ["us-east-2"];}) {
        # job.cardano.group.cardano.task.node.env.ENVIRONMENT = "testnet";
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "config/cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "kv/data/cardano/vasil-qa/bft-2";
      ...
      sp-1 = merge (cardano.nomadJob.default constants.envs.vasil-qa // {datacenters = ["eu-central-1"];}) {
        # job.cardano.group.cardano.task.node.env.ENVIRONMENT = "testnet";
        job.cardano.group.cardano.task.node.env.CONSUL_KV_PATH = "config/cardano/vasil-qa";
        job.cardano.group.cardano.task.node.env.VAULT_KV_PATH = "kv/data/cardano/vasil-qa/sp-1";
