...
in
{
  ...
  inherit (cardano-node.packages) cardano-node cardano-cli cardano-submit-api cardano-tracer bech32 db-synthesizer db-analyser db-truncater;
  inherit (cardano-faucet.legacyPackages) cardano-faucet;
